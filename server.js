...
<body>
	...
	<div class="container">
		<div align="center">
			<h1 class="title" style=" font-size: -webkit-xxx-large;">BitStream.ml</h1>
	...
	<script src="https://cdn.rawgit.com/mattboldt/typed.js/7aa30dd3/lib/typed.min.js"></script>
	...
	<script src="https://cdn.rawgit.com/zenorocha/clipboard.js/v1.7.1/dist/clipboard.min.js"></script>
		<script type="text/javascript">
			...
			var typed = new Typed('.title', { strings: ["Your personal file courier.", "Bitstream.ml"], typeSpeed: 30 });
...
app.get("*", function(request, response) {
	zlib.gzip('<html><head><meta content="width=device-width, initial-scale=1" name="viewport"></head><body> <div align="center" style="margin: 35vh 0vh; font-family: monospace!important;"><h1 style="font-size: 2rem; ">Not a valid url<br>:(</h1> <br> <a href="/">back</a> </div> </body></html>', function(error, result) {
		if (error) throw error;
		response.end(result);
	})
});
